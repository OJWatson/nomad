...
description of data censoring or aggregation, 
etc) will help guide 
...
### 4. Extensions (Milestone 2)

1. Tool for creating ensemble mobility models (predicting from multiple models
...
everything else. 
4. PRs to `mobility` for custom model specification
