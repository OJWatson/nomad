...
<!-- badges: start -->
[![R build status](https://github.com/OJWatson/nomad/actions/workflows/check-standard.yaml/badge.svg)](https://github.com/OJWatson/nomad/actions/workflows/check-standard.yaml.yaml)
...
Most users will come to use `nomad` with a shape file for which they want
mobility predictions.

```{r, eval=TRUE, echo=TRUE, include = TRUE, results="hide", message=FALSE, warning=FALSE}
library(tidyverse)
...
For our given shape file, we need to fetch population sizes, which `nomad`
makes easy by wrapping WorldPop
...
```{r, eval=TRUE, echo=TRUE, include = TRUE, message=FALSE, warning=FALSE, fig.height=8, fig.width=8, dpi=600}
